...
| 7 | 08.06.20 | {{% mention "kellner" %}} & <br/> Merten&nbsp;Stender | Explainable AI and its application to ice mechanics |
...
7. {{< hl >}}{{% mention "kellner" %}}, Merten Stender: Explainable AI and its application to ice mechanics.{{< /hl >}} <br/>
